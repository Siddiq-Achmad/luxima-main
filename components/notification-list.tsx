...
export function NotificationList({
  ...
  return (
    <div className="w-full max-w-sm lg:max-w-md mx-auto">
      <div className="relative bg-zinc-50/30 dark:bg-zinc-900/30 border border-zinc-200/30 dark:border-zinc-800/30 shadow-[0_1px_6px_0_rgba(0,0,0,0.02)] rounded-xl p-2 md:p-4">
        ...
        <div className="mt-1 ml-14">
          <p className="text-[12px] text-zinc-400 dark:text-zinc-500">{time}</p>
        </div>
      </div>
    </div>
  );
